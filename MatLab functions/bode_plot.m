...
if use_errs
    ...
    set(erp,'color',col,'linewidth',0.7,'linestyle',line,'marker',mark);
    set(gca,'xscale','log','yscale','log');
    setbarwidth(erp,f,0);
    setbarwidth(erp,f,0);
else
    loglog(f,mod_H,col,'linewidth',lwid,'linestyle',line,'marker',mark);
end
hold on;
grid on;
...
if use_errs
    ...
    semilogx(f,ang_deg,col,'linewidth',lwid,'linestyle',line,'marker',mark);
end
hold on;
grid on;
xlabel(f_label);
